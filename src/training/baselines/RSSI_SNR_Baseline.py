...
def main() -> None:
    ...
    metadata = {'model_id': MODEL_ID, 'model_name': MODEL_NAME, 'train_strategy': train_strategy, 'feature_columns': FEATURE_COLUMNS, 'rssi_threshold': float(rssi_t), 'snr_threshold': float(snr_t), 'train_accuracy': float(train_score)}
