...
sample_data = {'nodes': [{'node_id': 0, 'x': 0, 'y': 0, 'z': 50, 'vx': 5, 'vy': 0, 'vz': 0, 'speed': 5, 'degree': 2}, {'node_id': 1, 'x': 100, 'y': 0, 'z': 50, 'vx': -5, 'vy': 0, 'vz': 0, 'speed': 5, 'degree': 2}, {'node_id': 2, 'x': 50, 'y': 50, 'z': 60, 'vx': 0, 'vy': 5, 'vz': 0, 'speed': 5, 'degree': 2}], 'edges': [{'src': 0, 'dst': 1, 'distance': 100, 'rssi': -65, 'snr': 20, 'delay': 5, 'packet_loss': 0.01, 'relative_speed': 10, 'throughput': 10}, {'src': 1, 'dst': 2, 'distance': 70, 'rssi': -55, 'snr': 25, 'delay': 3, 'packet_loss': 0.005, 'relative_speed': 5, 'throughput': 15}, {'src': 0, 'dst': 2, 'distance': 70, 'rssi': -80, 'snr': 10, 'delay': 15, 'packet_loss': 0.05, 'relative_speed': 5, 'throughput': 5}]}
...
if st.button('Predict'):
    try:
        ...
        with col2:
            ...
            ax.axis('off')
            nx.draw(G, pos, with_labels=True, node_color='#e0e0e0', font_size=9, edge_color=edge_colors, width=1.5, node_size=400, ax=ax)
            ...
            plt.legend(handles=[green_patch, red_patch], loc='lower center', bbox_to_anchor=(0.5, -0.1), ncol=2, frameon=False)
            st.pyplot(fig)
