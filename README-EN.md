...
_Ứng dụng Graph Neural Network trong dự đoán chất lượng liên kết và hỗ trợ định tuyến trong mạng UAV_

\> Quick start: see [docs/quick\_start.md](./docs/quick_start.md)
...
**Construct node and edge feature sets:**
...
**Compare with baselines and alternative models:**
...
**Support routing using predicted outputs:**
...
**Evaluate under two protocols with ablation analysis:**
